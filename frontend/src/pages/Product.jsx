...
import RelatedProducts from '../components/RelatedProduts';
...
const Product = () => {
  ...
  useEffect(() => {
    ...
    if (foundProduct) {
      ...
      setImage(foundProduct.image?.[0] || '/path/to/default/image.jpg'); // Added default image if not found
    } else {
    ...
    <div className="border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100">
      <div className="flex gap-12 sm:gap-12 sm:flex-row">
        ...
        <div className="flex-1 ">
            ...
            <div className="flex gap-2">
              {productData.sizes && productData.sizes.length > 0 ? (
                productData.sizes.map((item, index) => (
                  <button
                    onClick={() => handleSizeClick(item)}  // Update this to handle the click
          ...
          <button onClick={handleAddToCart} className="bg-black text-white px-8 py-3 text-sm active:bg-gray-700 cursor-pointer">
            ADD TO CART
          </button>
